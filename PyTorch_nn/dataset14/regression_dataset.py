...
def main():
    ...
    test_csv = "PyTorch_nn/dataset/test/labels.csv"
    test_img_dir = "PyTorch_nn/dataset/test"
    batch_size = 1
    THRESHOLD = 3.5
    ...
    df.to_csv("PyTorch_nn/dataset/test/pred_results.csv", index=False)
    # 统计 bias、mae 和 mse
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("PyTorch_nn/dataset/test/bias_plot.png")
