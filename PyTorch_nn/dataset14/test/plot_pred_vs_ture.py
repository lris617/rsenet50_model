...
csv_path = "PyTorch_nn/dataset14/test/pred_results14.csv"
...
plt.tight_layout()
plt.savefig("PyTorch_nn/dataset14/test/pred_vs_true14.png")
plt.close()
print("已保存图片: PyTorch_nn/dataset14/test/pred_vs_true14.png")
