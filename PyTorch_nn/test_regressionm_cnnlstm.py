...
# --------- 路径配置 ---------
model_save_dir = "report/cnnlstm14.2/resnet50_bs16_lr0.0001_feature256_lstm_layers3_hiddendim64"
...
test_img_dir = "PyTorch_nn/dataset4lstm14/test"
...
if __name__ == "__main__":
    ...
    # 可视化
    plt.figure()
    plt.scatter(true_deltas, pred_deltas, alpha=0.7)
    plt.xlabel("True Delta")
    plt.ylabel("Predicted Delta")
    plt.title("Test Set: True vs Predicted")
    plt.plot([min(true_deltas), max(true_deltas)], [min(true_deltas), max(true_deltas)], 'r--')
